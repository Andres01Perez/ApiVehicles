...
namespace Vehicles.Controllers
{
    ...
    public class HistoriesController : ControllerBase
    {
        ...
        {
            var history = await _context.Histories.OrderBy(v => v.Id).ToListAsync();
        ...
        {
            var history = await _context.Histories.FirstOrDefaultAsync(v => v.Id == id);
        ...
        public async Task<ActionResult<History>> PutHistory(int id, History history)
        {
            ...
            var exist = await _context.Histories.AnyAsync(v => v.Id == id);
        ...
        {
            History history = await _context.Histories.FirstOrDefaultAsync(v => v.Id == id);
