...
namespace Vehicles.Controllers
{
    ...
    public class DocumentTypesController : ControllerBase
    {
        ...
        {
            var documentType = await _context.DocumentTypes.OrderBy(v => v.nombre).ToListAsync();
        ...
        {
            var documentType = await _context.DocumentTypes.FirstOrDefaultAsync(v => v.Id == id);
        ...
        public async Task<ActionResult<Brand>> PutDocumentType(int id, DocumentType documentType)
        {
            ...
            var exist = await _context.DocumentTypes.AnyAsync(v => v.Id == id);
        ...
        {
            DocumentType documentType = await _context.DocumentTypes.FirstOrDefaultAsync(v => v.Id == id);
