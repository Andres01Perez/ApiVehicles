...
namespace Vehicles.Controllers
{
    ...
    public class DetailsController: ControllerBase
    {
        ...
        {
            var detail = await _context.Details.FirstOrDefaultAsync(v => v.Id == id);
        ...
        public async Task<ActionResult<Detail>> PutDetail(int id, Detail detail)
        {
            ...
            var exist = await _context.Details.AnyAsync(v => v.Id == id);
        ...
        {
            Detail detail = await _context.Details.FirstOrDefaultAsync(v => v.Id == id);
