...
namespace Vehicles.Controllers
{
    ...
    public class ProceduresController : ControllerBase
    {
        ...
        {
            var procedure = await _context.Procedures.OrderBy(v => v.Id).ToListAsync();
        ...
        {
            var procedure = await _context.Procedures.FirstOrDefaultAsync(v => v.Id == id);
        ...
        public async Task<ActionResult<Procedure>> PutProcedure(int id, Procedure procedure)
        {
            ...
            var exist = await _context.Procedures.AnyAsync(v => v.Id == id);
        ...
        {
            Procedure procedure = await _context.Procedures.FirstOrDefaultAsync(v => v.Id == id);
